...
class AdminEmaiverifyPage extends StatefulWidget {
  final String email;

  const AdminEmaiverifyPage({required this.email, Key? key}) : super(key: key);

  @override
  State<AdminEmaiverifyPage> createState() => _VerifyEmailPageState();
}

class _VerifyEmailPageState extends State<AdminEmaiverifyPage>
